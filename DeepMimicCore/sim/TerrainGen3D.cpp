						...
						const Eigen::VectorXd& params, cRand& rand, std::vector<float>& out_data, std::vector<int>& out_flags)
{
	...
	out_res[0] = CalcResX(ground_size[0], spacing_x);
	out_res[1] = CalcResZ(ground_size[2], spacing_z);
	return AddPath(origin, start_coord, ground_size, spacing_x, spacing_z, out_res, w, len, turn_len, h0, h1, out_data, out_flags);
}
...
void cTerrainGen3D::AddPath(const tVector& origin, const Eigen::Vector2i& start_coord, const tVector& size, double spacing_x, double spacing_z,
							const Eigen::Vector2i& out_res, double w, double len, double turn_len, double h0, double h1,
							std::vector<float>& out_data, std::vector<int>& out_flags)
{
	int res_x = CalcResX(size[0], spacing_x);
	int res_z = CalcResX(size[2], spacing_z);
...
void cTerrainGen3D::AddCliff(const tVector& origin, const Eigen::Vector2i& start_coord, const tVector& size, double spacing_x, double spacing_z,
							const Eigen::Vector2i& out_res, std::vector<float>& out_data, std::vector<int>& out_flags)
{
	const double h0 = 0;
	const double h1 = 2;
...
void cTerrainGen3D::AddRamp(const tVector& origin, const Eigen::Vector2i& start_coord, const tVector& size, double spacing_x, double spacing_z,
...
void cTerrainGen3D::AddCheckers(const tVector& origin, const Eigen::Vector2i& start_coord, const tVector& size, double spacing_x, double spacing_z, double slope,
							const Eigen::Vector2i& out_res, std::vector<float>& out_data, std::vector<int>& out_flags)
{
	const double pad = 1;
...
void cTerrainGen3D::AddStairs(const tVector& origin, const Eigen::Vector2i& start_coord, const tVector& size, double spacing_x, double spacing_z
